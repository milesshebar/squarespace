...
//Function that sends all client color changes to server
...
//Function that recieves new color changes from the server
s.on('message', function (message) {
  //object provided: "message: {id: '#tx', colorname: 'is-color'}"
